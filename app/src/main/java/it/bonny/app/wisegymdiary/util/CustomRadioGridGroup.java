...
public class CustomRadioGridGroup extends GridLayout {
    ...
    public CustomRadioGridGroup(Context context) {
        super(context);
        init();
    }

    public CustomRadioGridGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(CustomRadioGridGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(CustomRadioGridGroup.class.getName());
    }

    public interface OnCheckedChangeListener {
        void onCheckedChanged(CustomRadioGridGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == CustomRadioGridGroup.this && child instanceof AppCompatRadioButton) {
                int id = child.getId();
